    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" action="<?=base_url('index.php/user/loginCheck')?>" method="post">
                    <?php
                    if(isset($flash))
                    {
                        echo $flash;
                    ...
                    <p class="help-block" style="color: #960004 "><?=form_error('username','<div class="help-block" style="color: red ">', '</div>')?></p>
                    ...
                    <div class="form-group">
                        ...
                        <div style="font-size:85%">
                            ...
                            <a href="<?=base_url()?>" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                Sign Up Here
                            </a>
                        </div>
