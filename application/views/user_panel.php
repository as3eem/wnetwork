 ...
 */
        ...
        @font-face {
            ...
            src: url('<?=base_url()?>/fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'), url('<?=base_url()?>/fonts/glyphicons-halflings-regular.woff2') format('woff2'), url('<?=base_url()?>/fonts/glyphicons-halflings-regular.woff') format('woff'), url('../fonts/glyphicons-halflings-regular.ttf') format('truetype'), url('../fonts/glyphicons-halflings-regular.svg#glyphicons_halflingsregular') format('svg');
        }
        .glyphicon {
            position: relative;
            top: 1px;
...
<div class="header-section">
    <div class="continer">
        <img src="<?=base_url()?>images/p1.png">
        <h1>hello..<span>!</span></h1>
        <p><h2><?=$name?> <span style="size: 40px; color: red;">|</span> <?= $work ?></h2></p>
...
<div class="study-section">
    <div class="container">
        <div class="study-grids">
            ...
            <div class="col-md-6 study-grid">
              <form action="<?= base_url('index.php/user/reqCheck') ?>" method="post">
                <div align="center"><button type="submit" class="btn btn-primary" >CHECK WHO WANTS TO BE YOUR FRIEND!</button></div></form>
            </div>
...
<!--    <p>The form below contains two input elements; one of type text and one of type password:</p>-->
    <form action="<?=base_url('index.php/user/searchUser')?>" method="POST">
...
<!--            <h4>Network</h4>-->
        ...
        <div class="col-md-4 face">
            <p><i class="facebook"> </i><h2>Network of <span style="color: red; size: 20px;">45</span> professionals.</h2> </p>
<!--            <h4>Network</h4>-->
        </div>
        <div class="col-md-1 face">
<!--            <p><i class="facebook"> </i>450 </p>-->
...
<div style="margin-left: 40%; padding-bottom: 5%;"><button type="submit" class="btn btn-primary btn-lg">Connect With <?=$name?></button></div>
</form>
<!--end-social-section-->
...
<div class="footer-section">
    <div class="container">
        <div class="footer-top">
            <p>&copy; 2015 <span>Hello.</span> All rights reserved | Design by CODE CHAMPS.
        <script type="text/javascript">
