...
--*/
        ...
        body {
            background: #673AB7;
            background: linear-gradient(to top, rgb(178, 69, 146), rgb(241, 95, 121));
    ...
    <div class="main-agileinfo">
        <div class="agileits-top">
            <form action="#" method="post">
                ...
                <div style="margin-top: 2em; margin-bottom: 2em;"><input class="text" type="text" name="exp" placeholder="Experience" ></div>
                <input class="text" type="text" name="org" placeholder="Working Organisation">
<!--                <input class="text w3lpass" type="password" name="password" placeholder="Confirm Password" required="">-->
            ...
            <p> Have an Account? <a href="<?=base_url('index.php/user/login')?>"> Login Now!</a></p>
        </div>
    </div>
    <!-- copyright -->
